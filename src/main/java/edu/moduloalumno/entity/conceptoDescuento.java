...
public class conceptoDescuento implements Serializable {
    ...
    public conceptoDescuento(Integer id_programa_ciclo, Integer id_concepto, String concepto, String descripcion_min, Integer credito, Integer importe, float descuento, float importe_final, Integer cuotas) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        conceptoDescuento other = (conceptoDescuento) obj;
